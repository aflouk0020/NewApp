...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean checkCredentials(String username, String password) {
        DBAccess dbAccess = new DBAccess(MainActivity.this);
        Cursor cursor = null;
        try {
            cursor = dbAccess.getUserDetails(username);
            if (cursor != null && cursor.moveToFirst()) {
                ...
                // Save user ID into SharedPreferences for later
                dbAccess.saveUserIdToSharedPreferences(MainActivity.this, username, userId);
...
//        try {
//            cursor = dbAccess.getUserDetails(username);
//            // Check if the cursor has any data (i.e., user exists)
//            if (cursor != null && cursor.moveToFirst()) {
//                String storedPassword = cursor.getString(cursor.getColumnIndex("password"));
//                return storedPassword.equals(password);  // Compare entered password with stored password
//            }
